    ...
    <main className="app-shell">
      ...
      <section className="content">
        ...
        <div className="journey-card">
          <div className="journey-main"><div className="route-label"><span>YOUR JOURNEY</span><span className="status-pill"><span className="live-dot" /> Running 18 min late</span></div><h2>12901 <span>Gujarat Mail</span></h2><div className="route"><b>Ahmedabad</b><ArrowRight size={18} /><b>Mumbai</b></div><p className="muted">Next stop <strong>Nadiad</strong> · Updated 5 min ago</p></div>
          <div className="train-illustration"><div className="sun" /><div className="track" /><TrainFront size={88} strokeWidth={1.2} /></div>
          <div className="journey-actions"><button className="secondary">View PNR</button><button className="primary">Live Status <ArrowRight size={16} /></button></div>
        </div>

        <section className="social-section">
          <div className="section-heading"><div><p className="eyebrow blue">THE REASON EXPRESS EXISTS</p><h2>People on your train</h2><p className="muted">You’re sharing this journey with <strong>42 people</strong> who are open to connect.</p></div><button className="link-button">See all <ChevronRight size={16} /></button></div>
        ...
        <div className="quick-grid"><div className="quick"><div className="quick-icon"><TrainFront size={18} /></div><div><strong>Check PNR</strong><small>Booking & seat status</small></div><ChevronRight size={17} /></div><div className="quick"><div className="quick-icon green"><Clock3 size={18} /></div><div><strong>Live Train Status</strong><small>Stops & running updates</small></div><ChevronRight size={17} /></div><div className="quick"><div className="quick-icon pink"><Heart size={18} /></div><div><strong>Connections</strong><small>People you’ve met</small></div><ChevronRight size={17} /></div></div>
