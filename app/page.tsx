  ...
  return (
    <main className="app-shell">
      ...
      <section className="content">
        ...
        <div className="quick-grid"><Link className="quick" href="/pnr"><div className="quick-icon"><TrainFront size={18} /></div><div><strong>Check PNR</strong><small>Booking & seat status</small></div><ChevronRight size={17} /></Link><Link className="quick" href="/train-status"><div className="quick-icon green"><Clock3 size={18} /></div><div><strong>Live Train Status</strong><small>Stops & running updates</small></div><ChevronRight size={17} /></Link><div className="quick"><div className="quick-icon pink"><Heart size={18} /></div><div><strong>Connections</strong><small>People you’ve met</small></div><ChevronRight size={17} /></div></div>
